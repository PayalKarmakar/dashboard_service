...
public partial class CameraConfigurationPage : Page
{
    ...
    private async void AddCamera_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            await LoadCamerasAsync();
            await ReloadBackgroundMonitoringAsync();
        }
    }
    ...
    private static async Task ReloadBackgroundMonitoringAsync()
    {
        ...
        try
        {
            await CameraBackgroundMonitoringService.Instance.ReloadAsync();
        }
        catch (Exception ex)
        {
            System.Diagnostics.Debug.WriteLine(
                $"Background camera monitoring reload failed: {ex.Message}");
        }
    }
